...
class CloudinaryService @Inject constructor(
    ...
    suspend fun removeBackground(bitmap: Bitmap): Bitmap? = withContext(Dispatchers.IO) {
        try {
            ...
            // Construct the transformation URL: e_background_removal,b_white
            // Example: https://res.cloudinary.com/dcudjmopb/image/upload/v12345/shopeelister-bg/abc.png
            // Target: https://res.cloudinary.com/dcudjmopb/image/upload/b_white,e_background_removal/v12345/shopeelister-bg/abc.jpg
            val transformedUrl = "https://res.cloudinary.com/$cloudName/image/upload/b_white,e_background_removal/v$version/$publicId.jpg"
